...
const en = {
  ...
  "gh.publish": "Publish to GitHub",
  "gh.published": "Issue created on GitHub",
  "gh.setupTitle": "Publish to GitHub",
  "gh.setupNote":
    "The token and target live only in this browser (localStorage). Nothing is sent anywhere except api.github.com.",
  "gh.patLabel": "Personal access token (repo scope)",
  "gh.patPlaceholder": "github_pat_… or ghp_…",
  "gh.targetLabel": "Target repository",
  "gh.targetPlaceholder": "owner/repo",
  "gh.save": "Save",
  "gh.remove": "Remove token",
  "gh.cancel": "Cancel",
  "gh.saved": "GitHub publishing configured.",
  "gh.removed": "Token removed.",
  "gh.errAuth": "GitHub rejected the token — paste a valid one.",
  "gh.errForbidden": "No permission on that repository (or rate-limited).",
  "gh.errValidation": "Repository not found or invalid — check owner/repo.",
  "gh.errNetwork": "Could not reach api.github.com.",
  "gh.errUnknown": "Publishing failed.",
...
const zh: Record<I18nKey, string> = {
  ...
  "gh.publish": "发布到 GitHub",
  "gh.published": "已在 GitHub 创建 Issue",
  "gh.setupTitle": "发布到 GitHub",
  "gh.setupNote": "令牌和目标仓库只保存在这个浏览器里（localStorage），除了 api.github.com 不发往任何地方。",
  "gh.patLabel": "个人访问令牌（repo 权限）",
  "gh.patPlaceholder": "github_pat_… 或 ghp_…",
  "gh.targetLabel": "目标仓库",
  "gh.targetPlaceholder": "owner/repo",
  "gh.save": "保存",
  "gh.remove": "清除令牌",
  "gh.cancel": "取消",
  "gh.saved": "GitHub 发布已配置。",
  "gh.removed": "令牌已清除。",
  "gh.errAuth": "GitHub 拒绝了该令牌——请粘贴有效的令牌。",
  "gh.errForbidden": "对目标仓库没有权限（或触发了限流）。",
  "gh.errValidation": "仓库不存在或名称有误——检查 owner/repo。",
  "gh.errNetwork": "无法连接 api.github.com。",
  "gh.errUnknown": "发布失败。",
